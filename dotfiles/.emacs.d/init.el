...
(custom-set-variables
 ...
 '(package-selected-packages
   '(move-text astyle zig-mode zenburn-theme yasnippet yaml-mode which-key vertico unicode-escape undo-tree typescript-mode rust-mode quelpa-use-package projectile orderless lsp-pyright iedit hydra haskell-mode gruber-darker-theme frame-local flymake-easy flycheck-nimsuggest evil-collection epc disable-mouse commenter autothemer auctex async ansible)))
(custom-set-faces
