...
(map! :leader :n "lr" #'lsp-find-references)
(map! :leader :n "ld" #'lsp-find-definition)
(map! :leader :n "li" #'lsp-find-implementation)
(map! :leader :n "lc" #'lsp-execute-code-action)
(map! :leader :n "lf" #'lsp-format-buffer)
(map! :leader :n "ll" #'flycheck-list-errors)
(map! :leader :n "ln" #'flycheck-next-error)
