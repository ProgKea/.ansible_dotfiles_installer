...
_G.packer_plugins = {
  ...
  ["defx-icons"] = {
    loaded = true,
    path = "$HOME/.local/share/nvim/site/pack/packer/start/defx-icons",
    url = "https://github.com/kristijanhusak/defx-icons"
  },
  gruvbox = {
    loaded = true,
    path = "$HOME/.local/share/nvim/site/pack/packer/start/gruvbox",
  ...
  ["lsp-colors.nvim"] = {
    loaded = true,
    path = "$HOME/.local/share/nvim/site/pack/packer/start/lsp-colors.nvim",
    url = "https://github.com/folke/lsp-colors.nvim"
  },
  ["lspkind-nvim"] = {
    loaded = true,
    path = "$HOME/.local/share/nvim/site/pack/packer/start/lspkind-nvim",
    url = "https://github.com/onsails/lspkind-nvim"
  },
  ["lspsaga.nvim"] = {
    loaded = true,
    path = "$HOME/.local/share/nvim/site/pack/packer/start/lspsaga.nvim",
    url = "https://github.com/glepnir/lspsaga.nvim"
  },
  neoformat = {
    loaded = true,
    path = "$HOME/.local/share/nvim/site/pack/packer/start/neoformat",
    url = "https://github.com/sbdchd/neoformat"
  },
  neogit = {
    loaded = true,
    path = "$HOME/.local/share/nvim/site/pack/packer/start/neogit",
  ...
  ["telescope-fzy-native.nvim"] = {
    loaded = true,
    path = "$HOME/.local/share/nvim/site/pack/packer/start/telescope-fzy-native.nvim",
  ...
  ["tokyonight.nvim"] = {
    loaded = true,
    path = "$HOME/.local/share/nvim/site/pack/packer/start/tokyonight.nvim",
