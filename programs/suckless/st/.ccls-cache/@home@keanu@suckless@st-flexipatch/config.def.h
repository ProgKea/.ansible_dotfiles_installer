 ...
 */
//static char *font = "Inconsolata Nerd Font:pixelsize=18:antialias=true:autohint=true";
...
//static char *font = "Minecrafter:pixelsize=18:antialias=true:autohint=true";
